	...
	<body>
		<div class="wrapper">
			...
			<section class="courses">
				<article>
					<figure>
						<img src="images/baju.png" alt="baju" />
						<figcaption>Baju 1 kilo</figcaption>
					</figure>
					<hgroup>
						<h2>1 KILO</h2>
				...
				<article>
					<figure>
						<img src="images/baju1.jpg" alt="baju" />
						<figcaption>Baju 2 kilo</figcaption>
					</figure>
					<hgroup>
						<h2>2 KILO</h2>
			...
			<aside>
				<section class="popular-recipes">
					<h2>KATEGORI</h2>
<?php
			$hasil = mysqli_query($kon, "SELECT * FROM harga") or die("Gagal QUery Harga");
			while($r = mysqli_fetch_assoc($hasil)) {
					echo "<a href='pembayaran.php?id={$r['id_jasa']}&nama={$r['nama']}&harga={$r['harga_perkilo']}'>".$r['nama']."</a>";
			}
?>
			</section>
			<section class="popular-recipes">
